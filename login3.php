    ...
    <div id="header">
        <main class="main-content">
            <div class="form-container">
                <h2 class="heading" style="padding-bottom: 30px">Login In To See Your <br> Pending Requests</h2>
                <form method="POST" action="login3.php">
                    ...
                    <div class="input-group">
                        ...
                        <br>
                        <a href="register.php" class="btn-secondary" id="tap" style="font-size=15px; padding-left:10px;">Haven't made a request yet? Register</a>
